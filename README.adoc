...
.Prepare
====
Please read link:UseageType.adoc[] first.
...
In addition, some projects need to be installed according to specific types. See link:UseageType.adoc[Useage Type].
...
1. Use Asciidoctor PDF CJK Ext Theme (select link:UseageType.adoc[Useage Type] to select one.)
...
2. Use Asciidoctor PDF CJK Ext Theme (select link:UseageType.adoc[Useage Type] to select one.)
...
[cols="1,2,2"]
|===
|UseageType| asciidoctor-pdf-cjk-ext theme | use custome theme
